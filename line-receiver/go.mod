module github.com/thetkpark/uob-thai-credit-card-notification-forwarder/line-receiver
...
require (
	...
	github.com/thetkpark/uob-thai-credit-card-notification-common v0.0.0-20250122143103-c27be4e299d9
)
